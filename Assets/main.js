!(function (t) {
  ...
  aWFY: function (t, e, n) {
    ...
    (function (t) {
      function i() {
        var e = 0;
        t(".navbar-default").removeClass("active").addClass("navbar-fixed-top"),
        ...
        (e.prototype.listen = function () {
          ...
          (e.prototype._touchMove = function (e) {
            Math.abs(e.touches[0].pageY - this._initialTouchPosition) > 10 &&
              (this._activeZoomClose(), t(e.target).off("touchmove.zoom"));
          }),
          (n.OFFSET = 80),
          (n._MAX_WIDTH = 2560),
          (n._MAX_HEIGHT = 4096),
    ...
    !(function (e, n) {
      ...
      function W(t, e, n, i, o) {
        ...
        for (
          ...
          "margin" === n && (s += yt.css(t, n + Bt[r], !0, o)),
            i
              ? ("content" === n && (s -= yt.css(t, "padding" + Bt[r], !0, o)),
                "margin" !== n &&
      ...
      var Ct = (function (t) {
        function e(t, e, n, i) {
          ...
          if (
            !i &&
            ((e ? e.ownerDocument || e : F) !== j && D(e), (e = e || j), O)
          ) {
            if (11 !== h && (l = gt.exec(t)))
              if ((o = l[1])) {
                if (9 === h) {
          ...
          var o = n.length > 0,
            ...
            s = function (i, s, a, l, c) {
              ...
              for (
                ...
                if (r && u) {
                  for (
                    f = 0, s || u.ownerDocument === j || (D(u), (a = !O));
                    (d = t[f++]);
                    ...
                    (o(function (t) {
                      (I.appendChild(t).innerHTML =
                        ...
                        t.querySelectorAll("[selected]").length ||
                          _.push("\\[" + tt + "*(?:value|" + J + ")"),
                        t.querySelectorAll("[id~=" + P + "-]").length ||
                          _.push("~="),
            ...
            function (t, e, n, i) {
              ...
              if (((n = n || []), 1 === d.length)) {
                if (
                  ...
                  if (
                    !(e = (x.find.ID(s.matches[0].replace(vt, yt), e) || [])[0])
                  )
                    return n;
                  u && (e = e.parentNode),
          ...
          function (t, e) {
            yt.fn[t] = function (n, i) {
              ...
              return (
                ...
                this.length > 1 &&
                  (It[t] || yt.uniqueSort(o), jt.test(t) && o.reverse()),
                this.pushStack(o)
              );
            };
          }
          ...
          yt.cssHooks[e] = {
            ...
            set: function (t, n, i) {
              var o,
                ...
                s =
                  i &&
                  W(t, e, i, "border-box" === yt.css(t, "boxSizing", !1, r), r);
              return (
                s &&
                  (o = zt.exec(n)) &&
                  "px" !== (o[3] || "px") &&
          ...
          if (
            ...
            for (r = 0; (s = d[r++]) && !t.isPropagationStopped(); )
              (t.type = r > 1 ? l : f.bindType || p),
                (u =
                  (Pt.get(s, "events") || {})[t.type] && Pt.get(s, "handle")),
                u && u.apply(s, e),
                (u = c && s[c]) &&
                  u.apply &&
                  Rt(s) &&
        ...
        yt.extend({
          ...
          ajax: function (t, e) {
              ...
              u ||
                ...
                c
                  ? (h.ifModified &&
                      ...
                      (x = C.getResponseHeader("etag")) && (yt.etag[r] = x)),
                    204 === t || "HEAD" === h.type
                      ? (T = "nocontent")
                      : 304 === t
                      ? (T = "notmodified")
                      : ((T = w.state), (d = w.data), (p = w.error), (c = !p)))
            ...
            if (
              ...
              (h.dataTypes = (h.dataType || "*").toLowerCase().match(Ot) || [
                "",
              ]),
              null == h.crossDomain)
            ) {
              ...
              try {
                (c.href = h.url),
                  (c.href = c.href),
                  (h.crossDomain =
                    Be.protocol + "//" + Be.host != c.protocol + "//" + c.host);
              } catch (t) {
                h.crossDomain = !0;
              }
            }
            ...
            (f = yt.event && h.global),
              ...
              h.hasContent
                ...
                : ((p = h.url.slice(r.length)),
                  h.data &&
                    ((r += (Ae.test(r) ? "&" : "?") + h.data), delete h.data),
                  !1 === h.cache &&
                    ((r = r.replace(qe, "$1")),
                    (p = (Ae.test(r) ? "&" : "?") + "_=" + Ne++ + p)),
                  (h.url = r + p)),
      ...
      yt.ajaxSetup({
        ...
        yt.each(["top", "left"], function (t, e) {
          yt.cssHooks[e] = R(vt.pixelPosition, function (t, n) {
            if (n)
              return (n = q(t, e)), ce.test(n) ? yt(t).position()[e] + "px" : n;
          });
        }),
